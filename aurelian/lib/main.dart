...
import 'package:aurelian/completed_games_page.dart';
import 'package:aurelian/create_game_page.dart';
import 'package:aurelian/db.dart';
import 'package:aurelian/game.dart';
import 'package:aurelian/game_page.dart';
import 'package:aurelian/in_progress_games_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        title: 'Aurelian, Restorer of the World',
        theme: ThemeData(
