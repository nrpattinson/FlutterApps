...
import 'package:the_first_jihad/completed_games_page.dart';
import 'package:the_first_jihad/create_game_page.dart';
import 'package:the_first_jihad/db.dart';
import 'package:the_first_jihad/game.dart';
import 'package:the_first_jihad/game_page.dart';
import 'package:the_first_jihad/in_progress_games_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        title: 'The First Jihad',
        theme: ThemeData(
          colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFFB7A986), brightness: Brightness.light),
          useMaterial3: true,
        ),
      home: MyHomePage(),
      )
...
class MyAppState extends ChangeNotifier {
  ...
  void newGame(Scenario scenario, GameOptions options) async {
    ...
    _gameState = options.advanced ? GameState.setupAdvanced(random) : GameState.setupBasic(random);
