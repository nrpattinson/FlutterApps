...
import 'package:jeff_davis/completed_games_page.dart';
import 'package:jeff_davis/create_game_page.dart';
import 'package:jeff_davis/db.dart';
import 'package:jeff_davis/game.dart';
import 'package:jeff_davis/game_page.dart';
import 'package:jeff_davis/in_progress_games_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        title: 'Jeff Davis: The Confederacy at War',
        theme: ThemeData(
