...
import 'package:dont_tread_on_me/completed_games_page.dart';
import 'package:dont_tread_on_me/create_game_page.dart';
import 'package:dont_tread_on_me/db.dart';
import 'package:dont_tread_on_me/game.dart';
import 'package:dont_tread_on_me/game_page.dart';
import 'package:dont_tread_on_me/in_progress_games_page.dart';
...
class MyAppState extends ChangeNotifier {
  ...
  void newGame(Scenario scenario, GameOptions options) async {
    ...
    switch (scenario) {
    case Scenario.wholeWar:
      _gameState = GameState.setupCampaign();
    case Scenario.lateWar:
      _gameState = GameState.setupLateWar();
    }
