...
import 'package:china_inc/completed_games_page.dart';
import 'package:china_inc/create_game_page.dart';
import 'package:china_inc/db.dart';
import 'package:china_inc/game.dart';
import 'package:china_inc/game_page.dart';
import 'package:china_inc/in_progress_games_page.dart';
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        title: 'China, Inc.',
        theme: ThemeData(
          colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFFFECD21), brightness: Brightness.light),
          useMaterial3: true,
        ),
      home: MyHomePage(),
      )
