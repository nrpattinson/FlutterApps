...
import 'package:solitaire_caesar/game_page.dart';
import 'package:solitaire_caesar/in_progress_games_page.dart';
...
class MyAppState extends ChangeNotifier {
  ...
  void newGame(Scenario scenario, GameOptions options) async {
    ...
    case Scenario.campaign:
      _gameState = GameState.setupCampaign(options);
    case Scenario.riseAndFallOfTheWest:
      _gameState = GameState.setupRiseAndFallOfTheWest(options);
    case Scenario.justiniansReconquest:
      _gameState = GameState.setupJustiniansReconquest(options, random);
    }
