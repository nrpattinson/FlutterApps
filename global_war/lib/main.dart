...
import 'package:global_war/create_game_page.dart';
import 'package:global_war/db.dart';
import 'package:global_war/game.dart';
import 'package:global_war/game_page.dart';
import 'package:global_war/in_progress_games_page.dart';
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          colorScheme: ColorScheme.fromSeed(
            seedColor: const Color(0xFF910012),
...
class MyAppState extends ChangeNotifier {
  ...
  void newGame(Scenario scenario) async {
    ...
    final random = Random();
    gameState = scenario == Scenario.campaign ? GameState.setupCampaign() : GameState.setupTurningPoint(random);
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedIndex = appState.selectedPageIndex;
