...
import 'package:black_skin_black_shirt/completed_games_page.dart';
import 'package:black_skin_black_shirt/create_game_page.dart';
import 'package:black_skin_black_shirt/db.dart';
import 'package:black_skin_black_shirt/game.dart';
import 'package:black_skin_black_shirt/game_page.dart';
import 'package:black_skin_black_shirt/in_progress_games_page.dart';
import 'package:black_skin_black_shirt/random.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        title: 'Black Skin Black Shirt',
        theme: ThemeData(
          colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFFE5D860)),
          useMaterial3: true,
        ),
      home: MyHomePage(),
      )
...
class MyAppState extends ChangeNotifier {
  ...
  void newGame(Scenario scenario, GameOptions options) async {
    ...
    _gameState = GameState.setupStandard();
