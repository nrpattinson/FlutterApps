...
import 'package:the_mission/completed_games_page.dart';
import 'package:the_mission/create_game_page.dart';
import 'package:the_mission/db.dart';
import 'package:the_mission/game.dart';
import 'package:the_mission/game_page.dart';
import 'package:the_mission/in_progress_games_page.dart';
...
class MyAppState extends ChangeNotifier {
  ...
  void newGame(Scenario scenario, GameOptions options) async {
    ...
    _gameState = scenario == Scenario.riseOfIslam ? GameState.setupRiseOfIslam(random) : GameState.setupCampaign(random);
