...
import 'package:the_napoleonic_wars/completed_games_page.dart';
import 'package:the_napoleonic_wars/create_game_page.dart';
import 'package:the_napoleonic_wars/db.dart';
import 'package:the_napoleonic_wars/game.dart';
import 'package:the_napoleonic_wars/game_page.dart';
import 'package:the_napoleonic_wars/in_progress_games_page.dart';
...
class MyAppState extends ChangeNotifier {
  ...
  void newGame(Scenario scenario, GameOptions options) async {
    ...
    _gameState = GameState.fromScenario(scenario, random);
