...
import 'package:gorbachev/completed_games_page.dart';
import 'package:gorbachev/create_game_page.dart';
import 'package:gorbachev/db.dart';
import 'package:gorbachev/game.dart';
import 'package:gorbachev/game_page.dart';
import 'package:gorbachev/in_progress_games_page.dart';
...
class MyAppState extends ChangeNotifier {
  ...
  void previousTurn() async {
    int turn = 4 * _gameState!.currentYear + _gameState!.currentSeason;
    int targetTurn = turn;
