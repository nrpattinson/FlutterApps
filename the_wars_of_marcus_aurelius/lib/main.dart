...
import 'package:the_wars_of_marcus_aurelius/completed_games_page.dart';
import 'package:the_wars_of_marcus_aurelius/create_game_page.dart';
import 'package:the_wars_of_marcus_aurelius/db.dart';
import 'package:the_wars_of_marcus_aurelius/game.dart';
import 'package:the_wars_of_marcus_aurelius/game_page.dart';
import 'package:the_wars_of_marcus_aurelius/in_progress_games_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        title: 'The Wars of Marcus Aurelius',
        theme: ThemeData(
