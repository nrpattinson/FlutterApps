...
import 'package:nubia/completed_games_page.dart';
import 'package:nubia/create_game_page.dart';
import 'package:nubia/db.dart';
import 'package:nubia/game.dart';
import 'package:nubia/game_page.dart';
import 'package:nubia/in_progress_games_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        title: 'Nubia: Egypt’s Black Heirs',
        theme: ThemeData(
