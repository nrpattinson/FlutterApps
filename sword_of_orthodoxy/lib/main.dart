...
import 'package:sword_of_orthodoxy/completed_games_page.dart';
import 'package:sword_of_orthodoxy/create_game_page.dart';
import 'package:sword_of_orthodoxy/db.dart';
import 'package:sword_of_orthodoxy/game.dart';
import 'package:sword_of_orthodoxy/game_page.dart';
import 'package:sword_of_orthodoxy/in_progress_games_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        title: 'Sword of Orthodoxy',
        theme: ThemeData(
          colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFFDCB689)),
          useMaterial3: true,
        ),
      home: MyHomePage(),
      )
...
class MyAppState extends ChangeNotifier {
  ...
  void newGame(Scenario scenario, GameOptions options) async {
    ...
    _gameState = scenario == Scenario.campaign ? GameState.setupCampaign() : GameState.setupMillennium(random);
